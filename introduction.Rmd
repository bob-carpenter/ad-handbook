...
$$
The Hessian matrix is symmetric, with $\textrm{H}_f(x)[m, n] = \textrm{H}_f(x)[n, m]$.
...
An excellent reference for both matrix algebra and differential
calculus is [@magnus:2019].